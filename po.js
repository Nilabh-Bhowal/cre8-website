const APPS_SCRIPT_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbyoE98e2mLvI06XJzYgzRvwjvdTdpv2iJAWLKHSE0IbGyQEEJTFtwOdi2DVrA9_yYkZ/exec";
...
window.sendChatMessage = async function() {
    ...
    userInput.placeholder = "Processing request...";
    ...
    window[callbackName] = function (data) {
        ...
        userInput.placeholder = "Type your request...";
        userInput.focus();
